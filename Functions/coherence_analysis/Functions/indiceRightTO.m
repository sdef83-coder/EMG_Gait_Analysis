function [indiceRightTO] = indiceRightTO(data, analogs, freqS, freqVicon, EMG)
    ...
    RightTO = ((moments.Right_Foot_Off * freqVicon) - fsrt_frame) / freqVicon;
    TempsEMG = tempsE(N_EMG, freqS);  % Temps des échantillons EMG

    % Initialisation des variables
    time_to_find = RightTO;  
